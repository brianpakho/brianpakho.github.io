...
- Proof-of-concept showing how a Slack-based AI agent with access to Austin FC's data can expand the BI team's capacity and respond to requests across departments.
...
- Exploration of a potential Austin FC data pipeline and the platforms involved.
